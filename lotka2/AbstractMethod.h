...
/*
* Represents the abstract numerical methods for solving the differential equeations
*/
class AbstractMethod
{
/*
* To calculate the next point with method in derived class.
...
public :
	virtual void step(AbstractModell& model, Eigen::VectorXd& yi_plus_1,
		const std::vector<Eigen::VectorXd>& yi, const int& rank, const double& h) = 0;
};
